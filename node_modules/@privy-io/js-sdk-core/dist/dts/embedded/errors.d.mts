...
export declare function errorIndicatesMfaTimeout(error: unknown): error is PrivyIframeError;
export declare function errorIndicatesMfaVerificationFailed(error: unknown): error is PrivyIframeError;
export declare function errorIndicatesMaxMfaRetries(error: unknown): error is PrivyIframeError;
export declare function errorIndicatesMfaRateLimit(error: unknown): error is PrivyIframeError;
/**
