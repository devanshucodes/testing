...
export declare class Session extends EventEmitter<SessionEvent> {
    static events: readonly ["storage_cleared", "token_cleared", "refresh_token_cleared", "identity_token_cleared", "forked_token_cleared", "token_stored", "refresh_token_stored", "identity_token_stored", "oauth_tokens_granted", "error_storing_tokens"];
    constructor(o: Opts);
    ...
    /**
     * Set tokens in storage based on a Privy API response
     *
     * @param user response object from the Privy API with tokens
     *
     * @returns a list of any errors that occured trying to store the tokens
     */
