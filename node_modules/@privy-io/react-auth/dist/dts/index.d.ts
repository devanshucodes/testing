...
import { c as Chain, f as UserRecoveryMethod, i as PrivyFarcasterSignerInitResponse, j as MfaSubmitArgs, E as EthereumRpcRequestType, k as SolanaRpcRequestType, l as EthereumRpcResponseType, m as SolanaRpcResponseType, U as User, n as PrivyClientConfig, o as EIP1193Provider, p as WalletTimeoutError, q as RpcConfig, r as EntropyIdVerifier$1, s as RequestArguments, u as WalletConnector, B as BaseConnectedEthereumWallet, v as WalletClientType, w as ConnectedWalletMetadata, x as ConnectorType, y as WalletListEntry, z as ExternalWalletsConfig, A as BaseConnectedWallet, S as SolanaWalletConnector, D as ConnectWalletModalOptions, G as LoginModalOptions, H as CreateWalletOptions, W as Wallet, I as SetWalletRecoveryOptions, J as SignMessageModalUIOptions, K as SignTypedDataParams, M as MfaMethod, N as UnsignedTransactionRequest, Q as SendTransactionModalUIOptions, T as FundWalletConfig, V as TransactionReceipt, b as SupportedSolanaTransaction, a as SolanaTransactionReceipt, X as ConnectedWallet, O as OAuthTokens, Y as CrossAppProviderDetails, Z as OAuthProviderType, _ as MoonpaySignRequest, $ as MoonpaySignResponse, a0 as SmartWalletConfig, a1 as PrivyServerConfig, L as LoginMethod, a2 as SiweWalletMetadata, a3 as TelegramAuthResult, a4 as OAuthUserInfo, a5 as OAuthFlowState, a6 as LoginWithCode, a7 as OtpFlowState, a8 as PasskeyFlowState, a9 as SiweFlowState, aa as UnsignedTransactionRequestWithChainId, ab as BaseConnectedWalletType, C as ConnectedSolanaWallet, ac as CustomAuthFlowState } from './types-DIHtez5D.js';
export { at as Apple, aD as AppleOAuthWithMetadata, aL as ContractUIOptions, aw as CrossAppAccount, aG as CrossAppAccountWithMetadata, aq as Discord, az as DiscordOAuthWithMetadata, aI as Email, al as EmailWithMetadata, aP as Farcaster, aE as FarcasterWithMetadata, ar as Github, aA as GithubOAuthWithMetadata, ao as Google, ax as GoogleOAuthWithMetadata, d as LinkedAccountWithMetadata, as as LinkedIn, aC as LinkedInOAuthWithMetadata, aR as LoginMethodOrderOption, ae as MessageTypes, af as MoonpayConfig, ag as MoonpayCurrencyCode, aN as MoonpayFundingConfig, ah as MoonpayPaymentMethod, aM as NativeFundingConfig, ak as NonEmptyArray, aQ as Passkey, aH as PasskeyWithMetadata, aJ as Phone, am as PhoneWithMetadata, aO as PriceDisplayOptions, ai as Quantity, g as SolanaCluster, h as SolanaFundingConfig, av as Telegram, aF as TelegramWithMetadata, au as Tiktok, aB as TiktokOAuthWithMetadata, aj as TransactionLog, aK as TransactionUIOptions, ap as Twitter, ay as TwitterOAuthWithMetadata, ad as TypedMessage, an as WalletWithMetadata } from './types-DIHtez5D.js';
...
import { P as PrivyEvents } from './useFundSolanaWallet-BQJ4tqWZ.js';
export { C as CallbackError, a as UseFundSolanaWalletInterface, U as UseSolanaWalletsInterface, u as useSolanaWallets } from './useFundSolanaWallet-BQJ4tqWZ.js';
import 'viem';
...
interface UseImportWallet {
     ...
     * exit in the middle of the flow.
     *
     * @param o Input objecy
     * @param o.privateKey The private key of the ethereum wallet to import
     *
...
/**
 * Use this hook to import an extenral ethereum wallet into an embedded wallet via it's private key
 *
 * @returns The `importWallet` method
 */
declare const useImportWallet: () => UseImportWallet;
...
interface UseDelegatedActionsInterface {
    /**
     * Prompts the user to delegate access to their wallet to a trusted-execution environment (TEE) to allow an app to transact on behalf of a user
